...
public class PublicKeysActivity extends CustomActivity {
    ...
    private ArrayAdapter<DbTablePublicKeys.EntryWithName> listAdapterForDisplayedListOfEntries;
    ...
    private void setupUI(){
        ...
        listAdapterForDisplayedListOfEntries = new ArrayAdapter<>(
                this, R.layout.row_in_list, new ArrayList<DbTablePublicKeys.EntryWithName>());
        ...
        listView.setOnItemLongClickListener(new AdapterView.OnItemLongClickListener() {
            ...
            public boolean onItemLongClick(AdapterView<?> parent, View view, int position, long id) {
                synchronized (displayedEntriesLock) {
                    ...
                    final DbTablePublicKeys.Entry entry = listAdapterForDisplayedListOfEntries.getItem(position);
                    if (null == entry){
