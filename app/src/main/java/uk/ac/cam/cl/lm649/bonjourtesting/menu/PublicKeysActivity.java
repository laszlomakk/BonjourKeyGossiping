...
import uk.ac.cam.cl.lm649.bonjourtesting.database.tables.publickeys.PublicKeyEntryWithName;
...
public class PublicKeysActivity extends CustomActivity {
    ...
    private ArrayAdapter<PublicKeyEntryWithName> listAdapterForDisplayedListOfEntries;
    ...
    private void setupUI(){
        ...
        listAdapterForDisplayedListOfEntries = new ArrayAdapter<>(
                this, R.layout.row_in_list, new ArrayList<PublicKeyEntryWithName>());
        ...
        listView.setOnItemLongClickListener(new AdapterView.OnItemLongClickListener() {
            ...
            public boolean onItemLongClick(AdapterView<?> parent, View view, int position, long id) {
                synchronized (displayedEntriesLock) {
                    ...
                    final PublicKeyEntry entry = listAdapterForDisplayedListOfEntries.getItem(position);
                    if (null == entry){
        ...
        runOnUiThread(new Runnable() {
            ...
            public void run() {
                synchronized (displayedEntriesLock) {
                    ...
                    for (PublicKeyEntryWithName entry : DbTablePublicKeys.getAllEntries()) {
