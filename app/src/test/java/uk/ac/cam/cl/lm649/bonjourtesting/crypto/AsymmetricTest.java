...
public class AsymmetricTest {
    ...
    private static final boolean LONG_TESTS = true;

    public static final String HARDCODED_PRIVATE_KEY_1 =
    ...
    public static final String HARDCODED_PUBLIC_KEY_1 =
    ...
    public static final String HARDCODED_PRIVATE_KEY_2 =
            "-----BEGIN RSA PRIVATE KEY-----\n"+
    ...
    public static final String HARDCODED_PUBLIC_KEY_2 =
            "-----BEGIN RSA PUBLIC KEY-----\n"+
    ...
    public void testEncryptHexString() {
        try {
            ...
            AsymmetricKeyParameter privateKey = Asymmetric.stringKeyToKey(HARDCODED_PRIVATE_KEY_1);
            AsymmetricKeyParameter publicKey = Asymmetric.stringKeyToKey(HARDCODED_PUBLIC_KEY_1);
    ...
    public void testEncryptHexString2() {
        ...
        try {
            publicKey = Asymmetric.stringKeyToKey(HARDCODED_PUBLIC_KEY_1);
    ...
    public void testGetKeyPairFromKeys() {
        try {
            AsymmetricCipherKeyPair keyPair = Asymmetric.getKeyPairFromKeys(
                    Asymmetric.stringKeyToKey(HARDCODED_PUBLIC_KEY_1),
                    Asymmetric.stringKeyToKey(HARDCODED_PRIVATE_KEY_1));
    ...
    public void testGetKeyPairFromStringKeys() {
        try {
            AsymmetricCipherKeyPair keyPair = Asymmetric.getKeyPairFromStringKeys(
                    HARDCODED_PUBLIC_KEY_1,
                    HARDCODED_PRIVATE_KEY_1);
            //keyPair constructed, now try encrypting something
            String input = "dGVzdGluZyBteSBnbG9yaW91cyBtZXRob2Rz";
            String encrypted = Asymmetric.encryptBase64String(input, keyPair.getPrivate());
            String decrypted = Asymmetric.decryptBase64String(encrypted, keyPair.getPublic());
    ...
    public void testGetKeyPairFromByteKeys() {
        try {
            byte[] pubKey = Asymmetric.stringKeyToByteKey(HARDCODED_PUBLIC_KEY_1);
            byte[] privKey = Asymmetric.stringKeyToByteKey(HARDCODED_PRIVATE_KEY_1);
    ...
    public void testKeyConversion1() {
        try {
            String myPrivKey2 = Asymmetric.keyToStringKey(Asymmetric.stringKeyToKey(HARDCODED_PRIVATE_KEY_1));
            String myPubKey2 = Asymmetric.keyToStringKey(Asymmetric.stringKeyToKey(HARDCODED_PUBLIC_KEY_1));
            assertEquals(HARDCODED_PRIVATE_KEY_1, myPrivKey2 );
            assertEquals(HARDCODED_PUBLIC_KEY_1, myPubKey2 );
        } catch (Exception e) {
            e.printStackTrace();
            fail();
        }
    ...
    public void testKeyConversion2() {
        try {
            String myPrivKey2 = Asymmetric.byteKeyToStringKey(Asymmetric.stringKeyToByteKey(HARDCODED_PRIVATE_KEY_1));
            String myPubKey2 = Asymmetric.byteKeyToStringKey(Asymmetric.stringKeyToByteKey(HARDCODED_PUBLIC_KEY_1));
            assertEquals(HARDCODED_PRIVATE_KEY_1, myPrivKey2 );
            assertEquals(HARDCODED_PUBLIC_KEY_1, myPubKey2 );
        } catch (Exception e) {
            e.printStackTrace();
    ...
    public void testKeyConversion3() {
        try {
            AsymmetricKeyParameter privKey = Asymmetric.stringKeyToKey(HARDCODED_PRIVATE_KEY_1);
            AsymmetricKeyParameter pubKey = Asymmetric.stringKeyToKey(HARDCODED_PUBLIC_KEY_1);

            byte[] privKey_bytes = Asymmetric.keyToByteKey(privKey);
            byte[] pubKey_bytes = Asymmetric.keyToByteKey(pubKey);

            byte[] privKey_bytes2 = Asymmetric.stringKeyToByteKey(HARDCODED_PRIVATE_KEY_1);
            byte[] pubKey_bytes2 = Asymmetric.stringKeyToByteKey(HARDCODED_PUBLIC_KEY_1);
    ...
    public void testIsValidKey_string() {
        //test hardcoded keys
        assertTrue( Asymmetric.isValidKey(HARDCODED_PRIVATE_KEY_1) );
        assertTrue( Asymmetric.isValidKey(HARDCODED_PUBLIC_KEY_1) );
        assertTrue( Asymmetric.isValidKey(HARDCODED_PRIVATE_KEY_2) );
        assertTrue( Asymmetric.isValidKey(HARDCODED_PUBLIC_KEY_2) );
    ...
    public void testIsValidKey_byte() {
        //test hardcoded keys
        try {
            assertTrue( Asymmetric.isValidKey(Asymmetric.stringKeyToByteKey(HARDCODED_PRIVATE_KEY_1)) );
            assertTrue( Asymmetric.isValidKey(Asymmetric.stringKeyToByteKey(HARDCODED_PUBLIC_KEY_1)) );
            assertTrue( Asymmetric.isValidKey(Asymmetric.stringKeyToByteKey(HARDCODED_PRIVATE_KEY_2)) );
            assertTrue( Asymmetric.isValidKey(Asymmetric.stringKeyToByteKey(HARDCODED_PUBLIC_KEY_2)) );
        } catch (KeyDecodingException e1) {
            fail();
            return;
        }
